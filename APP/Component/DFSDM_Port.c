...
{
  if((DmaRecHalfBuffCplt_2 == 0) && (DmaRecBuffCplt_2 == 0))
  {
    return;
  }

  int16_t *PCM_Data_Ptr = (DmaRecHalfBuffCplt_2 == 1)?(int16_t *)Pdm2Pcm_ChannelBuf[1].PCM_Buf:(int16_t *)Pdm2Pcm_ChannelBuf[1].PCM_Buf+PCM_ONE_SAMPLE_NUM;
