...
#define AUDIO_IN_EP                                   0x81 /* mod:0x82 */
//#define USB_AUDIO_CONFIG_DESC_SIZ                     109
#define USB_AUDIO_CONFIG_DESC_SIZ                     110
...
#define EP1_MAX_PKT_SIZE    ((DSCP_BUFFER_SIZE*DSCP_DATA_BYTE)+30)
#define UAC_BUFFER_SIZE              DSCP_BUFFER_SIZE*60
#define UAC_BUFFER_HIGH_THRESHOLD    DSCP_BUFFER_SIZE*50
#define UAC_BUFFER_LOW_THRESHOLD     DSCP_BUFFER_SIZE*10
...
extern volatile int16_t g_UACRingBuf[];
